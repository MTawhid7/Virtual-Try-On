...
FABRIC_PRESETS: dict[str, FabricPreset] = {
    "cotton":  FabricPreset("cotton",  stretch_compliance=1e-7, bend_compliance=1.5e-2, density=0.30, damping=0.990, friction=0.35, max_stretch=0.03, max_compress=0.10, stretch_damping=0.20, bend_damping=0.10),
    "silk":    FabricPreset("silk",    stretch_compliance=5e-7, bend_compliance=3e-2,   density=0.12, damping=0.995, friction=0.20, max_stretch=0.05, max_compress=0.15, stretch_damping=0.10, bend_damping=0.05),
